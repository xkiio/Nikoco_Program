...
# Known bugs
# 00/00/00 - I fix my bugs overtime lol
...
virtual_options = ['Landscape Layout','Portrait (Full body)','Portrait (Half body)','Square Canvas/Album Cover',
                    'Wallpaper- Laptop/Tablet','Wallpaper- Iphone','Character Design Ref','Profile Picture',]
# list of physical options
physical_options = ['Landscape Layout','Poster Style','Portrait (Full body)','Portrait (Half body)',
                    'Square Canvas/Album Cover','Character Design Collage','Iphone Case','Sticker Designs (x5)',]
...
def exit():
        print ()
        print ("** Thank you for using our Nikoco Commissions Program! We hope to see you again! **")
        print ()
        order_list.clear()
        order_cost.clear()
...
def welcome():
    ...
    print("** I will be helping you to create your very own art commission. **")
    print("")
...
def n():
    ...
    restart = val_int(LOW, HIGH, question) # asks for input
    if restart == 1: # if input is 1 sends user to reboot
        print ()
        print ("Restarting program...") 
        main()
    else: # if input is 2 aborts program and prints farewell message
        exit()
...
def order_type():
    ...
    virtual = val_int(LOW, HIGH, question) # asks for input
    if virtual == 1: # if input is 1 follows virtual order function
        ...
        p_v = "virtual"
        virtual_info()
    else: # if input is 2 foll ows physical order function (NOT virtual function)
        print ("")
        print ("** For a physical delivery, we would like your name, phone number and home address where the final product will be sent! **")
        print ("** It is important that your details are correct- if you have made a mistake, you can redo your details after a full input. **")
        p_v = "physical"
        physical_info()
...
def new_exit():
    ...
    print ("** Unless you had previously cancelled your order, you may use the same details as before with your new order. **")
    print ()
